...
public class CircleTransition extends Transition {
    ...
    public CircleTransition(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.CircleTransition);
        setColor(a.getColor(R.styleable.CircleTransition_customColor, getColor()));
        a.recycle();

        mColor = context.getResources().getColor(R.color.grayColor50);
    ...
    public Animator createAnimator(final ViewGroup sceneRoot, TransitionValues startValues,
        ...
        growingFadeSet.setDuration(500);
